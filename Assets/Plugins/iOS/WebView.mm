...
{
    //xcode Classes/UI/UnityViewControllerBase.mm/  PrefersStatusBarHidden_DefaultImpl () / if(!_PrefersStatusBarHiddenInited) console Remove!
    NSLog(@"###### Called ShowStatusBar");
    NSNumber*  value = [NSNumber numberWithBool:bShow];
    [[[NSBundle mainBundle] infoDictionary] setValue:value forKey:@"UIStatusBarHidden"];
...
extern "C" {
    ...
    bool _WebViewPlugin_CanGoBack(void *instance);
    bool _WebViewPlugin_CanGoForward(void *instance);
    bool _WebViewPlugin_IsLoading(void *instance);
    void _WebViewPlugin_StopLoading(void *instance);
    void _WebViewPlugin_ShowStatusBar(void *instance, BOOL bShow);
    float _WebViewPlugin_GetStatusBarHPixel(void *instance);
}
...
{
    WebViewPlugin *webViewPlugin = (WebViewPlugin *)instance;
    [webViewPlugin ShowStatusBar:bShow];
}

float _WebViewPlugin_GetStatusBarHPixel(void *instance)
{
    WebViewPlugin *webViewPlugin = (WebViewPlugin *)instance;
    return [webViewPlugin GetStatusBarHPixel];
}
