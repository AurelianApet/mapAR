...
public static class ErrorMsg
{
    ...
    public static void Init()
    {
		...
		mErrorTitleMessage.font = Resources.Load ("NanumGothic") as Font;
		mErrorBodyMessage.font = Resources.Load("NanumGothic") as Font;
		mErrorOkButton.font = Resources.Load("NanumGothic") as Font;
